...
Fields are grouped per error message. The suffixes `_cy` and `_ly` stand for the year 2018 and 2017, respectively.
...
**"the sum of waste disposal routes must be less than or equal to 100%%"**

* `was_(l|i|wd|oth)_perc_cy`

**"the sum of diverted waste streams must be less than or equal to 100%%"**
...
**"must be equal to was_oth_perc_cy"**
...
**"must be equal to was_oth_perc_ly"**
