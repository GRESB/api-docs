...
Refer to our [Variable Whitelist](https://gresb-prd-public.s3.amazonaws.com/2024/data_partners/20230330_portfolio-api-endpoint-variable-whitelist.xlsx) document for a clear overview of all the variables which the users are allowed to interact with.
